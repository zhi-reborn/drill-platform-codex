-- =============================================================================
-- Migration from 960a06859b2a8115be6e819614c49c4f90e4f96a to the
-- multi-active schema.
--
-- This script is compatible with both MySQL and TiDB. It intentionally avoids
-- stored procedures because TiDB does not support them.
--
-- Usage:
