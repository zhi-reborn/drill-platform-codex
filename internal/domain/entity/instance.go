...
type DrillInstance struct {
	...
	CurrentStepID *uint64    `gorm:"type:bigint unsigned;column:current_task_id" json:"current_step_id"`
...
type StepInstance struct {
	...
	StepTemplateID           uint64     `gorm:"type:bigint unsigned;not null;column:template_step_id;index:idx_step_template_id" json:"step_template_id"`
	Name                     string     `gorm:"type:varchar(128);not null;column:name" json:"name"`
