...
function getCurrentStepName(drillId) {
...
for (const [drill] of __VLS_getVForSourceType((__VLS_ctx.activeDrills))) {
    ...
    // @ts-ignore
    const __VLS_52 = __VLS_asFunctionalComponent(DrillStatusBadge, new DrillStatusBadge({
        status: (drill.status),
        type: "drill",
    }));
    ...
    (__VLS_ctx.getCurrentStepName(drill.id));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "drill-actions" },
    });
...
var __VLS_43;
if (__VLS_ctx.activeDrills.length === 0) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "empty-tip" },
    });
}
...
{
    const { header: __VLS_thisSlot } = __VLS_70.slots;
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
        ...{ class: "card-title" },
    });
}
const __VLS_71 = {}.ElTable;
...
/** @type {__VLS_StyleScopedClasses['drill-header']} */ ;
/** @type {__VLS_StyleScopedClasses['drill-name']} */ ;
/** @type {__VLS_StyleScopedClasses['drill-progress']} */ ;
/** @type {__VLS_StyleScopedClasses['drill-current-step']} */ ;
/** @type {__VLS_StyleScopedClasses['label']} */ ;
/** @type {__VLS_StyleScopedClasses['value']} */ ;
/** @type {__VLS_StyleScopedClasses['drill-actions']} */ ;
