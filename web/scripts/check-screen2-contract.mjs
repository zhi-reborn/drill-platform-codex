...
assert.match(readFileSync(resolve(root, 'src/views/ScreenView.vue'), 'utf8'), /<button[\s\S]*?class="btn-icon btn-fullscreen-mark"[\s\S]*?@click="toggleFullscreen"/, 'ScreenView 全屏按钮必须保留并可切换全屏')
